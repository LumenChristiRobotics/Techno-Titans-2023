...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "leftFront")); //right encoder
        //^^^counter clockwise rotation is positive value
        //frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontEncoder"));
        //frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "leftRear")); //front encoder
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightRear")); //front encoder
